...
def check_singer():
    ...
    if not os.path.exists(tmp_dir):
        check_call(
            f"git clone -b v5.8.1 https://github.com/singer-io/singer-python.git {tmp_dir}".split()
        )
...
setup(
    name="source_dynamodb_singer",
    description="Source implementation for Dynamo DB, built on the Singer tap implementation.",
    author="Preemo",
    author_email="contact@preemo.io",
